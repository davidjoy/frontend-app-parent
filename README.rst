...
.. |license-badge| image:: https://img.shields.io/github/license/openedx/frontend-app-parent.svg
    :target: https://github.com/openedx/frontend-app-parent/blob/main/LICENSE
    :alt: License

.. |status-badge| image:: https://img.shields.io/badge/Status-Maintained-brightgreen

.. |ci-badge| image:: https://github.com/openedx/frontend-app-parent/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/openedx/frontend-app-parent/actions/workflows/ci.yml
    :alt: Continuous Integration

.. |codecov-badge| image:: https://codecov.io/github/openedx/frontend-app-parent/coverage.svg?branch=main
    :target: https://codecov.io/github/openedx/frontend-app-parent?branch=main
    :alt: Codecov
...
parent MFE for local development via the `devstack`_.
...
#. In an LMS shell, enable the ``ENABLE_parent_MICROFRONTEND`` feature flag:
   ...
   .. code-block::
      ...
      ---
      FEATURES:
          ENABLE_parent_MICROFRONTEND: true
...
#. Create and enable the waffle flag required to redirect users to the MFE,
   ...
   .. code-block::
      ...
      make lms-shell
      ./manage.py lms waffle_flag --create --everyone parent.redirect_to_microfrontend

#. Start this MFE with:

   .. code-block::

      cd frontend-app-parent
      nvm use
      npm ci
      npm start
...
https://github.com/openedx/frontend-app-parent/issues
...
.. _Backstage: https://open-edx-backstage.herokuapp.com/catalog/default/component/frontend-app-parent
